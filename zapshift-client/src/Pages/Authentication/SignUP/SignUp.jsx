...
// UI-only: form submits into AuthProvider's mock signup(). No Firebase call,
// no image upload API, no backend request — this is presentation-layer only.
const SignUp = () => {
    ...
    const handleSignUp = async (data) => {
        try {
            await signup({ name: data.name, email: data.email, photoURL: null });
